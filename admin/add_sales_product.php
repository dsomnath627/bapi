                ...
                <div class="page-content">
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"
                                    onclick="window.location.href='list_sales_products.php';">
                    ...
                    <div class="row">
                        <div class="col-xl-10 mx-auto">
                            <h6 class="mb-0 text-uppercase">Create Sales Product Entry</h6>
                            <hr>
                            <div class="card border-top border-0 border-4 border-primary">
                                <div class="card-body p-5">
                                    ...
                                    <form class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputEmail" class="form-label">Tea Name</label>
                                            <select class="form-select" id="inputGroupSelect01" name="tea_name">
