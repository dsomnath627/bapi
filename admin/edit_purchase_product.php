            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
							<button type="button" class="btn btn-primary" onclick="window.location.href='list_purchase_product.php';">
                            ...
                            <div class="card border-top border-0 border-4 border-primary">
                                <div class="card-body p-5">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary">Customer Entry</h5>
                                    </div>
                                    <hr>
                                    <form class="row g-3">
                                        <div class="col-md-6">
										...
										<select class="form-select" id="inputGroupSelect01" name = "c_price">
										
											<option value="iget"  style= "color:green">I Get</option>
											<option value="igive" style= "color:red">I Give</option>
										...
										<div class="col-md-6">
                                            ...
                                            <input type="email" class="form-control" id="inputFirstName" name = "c_amount">
                                        </div>
										...
										<label for="inputFirstName" class="form-label">Who are they?</label><br>

                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    id="inlineRadio1" value="option1" name = "c_customer">
                                                <label class="form-check-label" for="inlineRadio1">Customer</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                                    id="inlineRadio2" value="option2" name = "c_supplier">
                                        ...
                                        <div class="col-md-6">
                                            <label for="inputEmail" class="form-label">Shipping Address</label>
                                            <input type="email" class="form-control" id="inputEmail" name = "c_shipping_address">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" class="form-control" id="inputZip" name = "c_pin">
                                        </div>
                                        <div class="col-12">
