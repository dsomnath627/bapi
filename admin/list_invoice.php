                        ...
                        <div class="ms-auto">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary"
                                    onclick="window.location.href='add_purchase_product.php';">Add Purchase Products
                                </button>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <h4 class="mb-0">List Of Purchase Products</h4>
                            </div>
                            <hr />
                                ...
                                <table id="example2" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-outline-info m-1 px-1"  onclick="window.location.href='myinvoice.php';"><i
                                                        class='bx bx-cloud-download me-1'
                                                       ></i>Downloads</button>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-outline-danger m-1"
                                                    onclick="window.location.href='edit_company_details.php';"><i
                                                        class='bx bx-edit'></i>
                                                </button>
                                                <button type="button" class="btn btn-outline-info m-1"><i
                                                        class='lni lni-eraser'></i>
                                                </button>
                                            </td>
