				...
				<div class="page-content">
					...
					<div class="row">
                        <div class="col-xl-10 mx-auto">
                            <h6 class="mb-0 text-uppercase">Sales report Filter By date</h6>
                            <hr>
                            <div class="card border-top border-0 border-4 border-primary">
                                <div class="card-body p-5">
                                    ...
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary">Sales Product Filter</h5>
                                    </div>
                                    <hr>
                                    <form class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="teaprice" class="form-label">Start date</label>
                                            <input type="date" class="form-control" id="start_date" name="start_date"
                                                step="any">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="weight" class="form-label">End Date</label>
